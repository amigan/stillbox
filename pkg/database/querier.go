...
type Querier interface {
	...
	GetTalkgroups(ctx context.Context, filter *string) ([]GetTalkgroupsRow, error)
	GetTalkgroupsBySystem(ctx context.Context, system int32) ([]GetTalkgroupsBySystemRow, error)
	GetTalkgroupsBySystemCount(ctx context.Context, system int32, filter *string) (int64, error)
	GetTalkgroupsBySystemP(ctx context.Context, arg GetTalkgroupsBySystemPParams) ([]GetTalkgroupsBySystemPRow, error)
	GetTalkgroupsCount(ctx context.Context, filter *string) (int64, error)
