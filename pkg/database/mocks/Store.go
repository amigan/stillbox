...
// DBTX provides a mock function with no fields
...
// RecordUserLogin provides a mock function with given fields: ctx, username, lastLoginAt, lastLoginFrom
func (_m *Store) RecordUserLogin(ctx context.Context, username string, lastLoginAt pgtype.Timestamptz, lastLoginFrom *netip.Addr) error {
	ret := _m.Called(ctx, username, lastLoginAt, lastLoginFrom)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, pgtype.Timestamptz, *netip.Addr) error); ok {
		r0 = rf(ctx, username, lastLoginAt, lastLoginFrom)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Store_RecordUserLogin_Call) Run(run func(ctx context.Context, username string, lastLoginAt pgtype.Timestamptz, lastLoginFrom *netip.Addr)) *Store_RecordUserLogin_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(pgtype.Timestamptz), args[3].(*netip.Addr))
	})
	return _c
}

func (_c *Store_RecordUserLogin_Call) Return(_a0 error) *Store_RecordUserLogin_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Store_RecordUserLogin_Call) RunAndReturn(run func(context.Context, string, pgtype.Timestamptz, *netip.Addr) error) *Store_RecordUserLogin_Call {
	_c.Call.Return(run)
	return _c
}
