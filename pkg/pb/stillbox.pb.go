...
func file_stillbox_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stillbox_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_stillbox_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_stillbox_proto_msgTypes[10].OneofWrappers = []interface{}{}
	file_stillbox_proto_msgTypes[16].OneofWrappers = []interface{}{}
	type x struct{}
